...
$string['courseperrow'] = 'Courses per row';
$string['courseperrow_desc'] = 'Set the number of courses to display per row on the homepage (default: 4). This setting applies to desktop screens. Smaller screens will automatically adjust to show fewer courses per row for better viewing.';
...
$string['logo'] = 'Logo';
$string['logohtml'] = 'Logo HTML';
$string['logohtmldesc'] = 'Enter custom HTML code for the logo area. This allows you to create a custom logo using HTML instead of an uploaded image. You can use HTML tags like &lt;img&gt;, &lt;div&gt;, &lt;span&gt;, etc.';
